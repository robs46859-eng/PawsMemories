...
| 2. Multiview approval | Approved to begin | Legacy turnaround generation and a single-image Create concept path exist; `CANONICAL_ASSETS_ENABLED` remains false by default | Add migration 20 reference sessions/attempts/views/approvals, five immutable canonical views, consistency report, zoom/replace/retry/approve UI, and prove no 3D call before exact-manifest approval |
