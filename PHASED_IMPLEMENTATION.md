...
| 3. Durable 3D build and verification | Complete | Schema 22, `server/model-builds/` state machine, Tripo adapter, post-build GLB validation, credit debit/refund reconciliation | Release evidence: `phase-evidence/PHASE_3.md` |
