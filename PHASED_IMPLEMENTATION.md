...
| 2. Multiview approval | Complete (Signed off locally) | Schema 20 reference sessions/attempts/views/reports/approvals; 5 ordered canonical reference views; AI consistency reporting; zero 3D provider calls verified; 14/14 Phase 2 tests pass | Release evidence: `phase-evidence/PHASE_2.md` |
