...
| `STUDIO_PROXY_ENABLED` | `false`; enable only when a separate reachable Python Studio service is deployed |
| `STUDIO_SERVICE_URL` | leave blank unless that Studio service is deployed; blank returns a clear 503 instead of proxying to localhost |
