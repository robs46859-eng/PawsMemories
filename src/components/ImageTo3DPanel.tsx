...
import { submitImageTo3D, pollJob } from "../api";
import PetModelViewer from "./PetModelViewer";
import { Upload, X, Download, RotateCw, ChevronDown, ChevronUp, Layers, Sparkles, AlertCircle } from "lucide-react";
...
export default function ImageTo3DPanel({ credits, isAdmin, onCreditsSpent }: ImageTo3DPanelProps) {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      const result = await submitImageTo3D(image, multiview);
  ...
  }, [image, mvLeft, mvBack, mvRight, onCreditsSpent]);
    ...
    <div className="w-full max-w-2xl mx-auto px-4 py-6 md:py-10 animate-fade-in">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-on-surface-variant max-w-md mx-auto leading-relaxed">
          Upload any image and convert it into a downloadable GLB 3D model.
          Add optional side views for higher quality geometry.
        </p>
      </div>
