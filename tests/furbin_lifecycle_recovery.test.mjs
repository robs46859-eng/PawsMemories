...
test("FurBin exposes retry, soft-remove, removed-model, and restore controls", () => {
  ...
  for (const api of ["retryAvatarGeneration", "deleteAvatar", "fetchHiddenAvatars", "restoreAvatar"]) {
...
test("model library includes failed jobs but excludes soft-removed avatars", () => {
